...
\]  
(terms with \(p_i = 0\) are treated as 0). [geeksforgeeks](https://www.geeksforgeeks.org/machine-learning/gini-impurity-and-entropy-in-decision-tree-ml/)

Properties:  
- Entropy = 0 if one \(p_i = 1\) and all others 0 (pure node). [geeksforgeeks](https://www.geeksforgeeks.org/machine-learning/gini-impurity-and-entropy-in-decision-tree-ml/)
- Entropy is maximal when all classes are equally likely (for binary: \(p_1 = p_2 = 0.5 \Rightarrow \text{Entropy} = 1\)). [geeksforgeeks](https://www.geeksforgeeks.org/data-science/how-to-calculate-entropy-in-decision-tree/)
...
\[
\text{Entropy}(A) = -[1 \log_2 1 + 0 \log_2 0] = 0
\]  
...
\[
\text{Entropy}(B) = -[0.5 \log_2 0.5 + 0.5 \log_2 0.5]
= -[0.5(-1) + 0.5(-1)] = 1
\]  
...
The weights are proportional to the number of samples going into each child. [nebius](https://nebius.com/blog/posts/entropy-in-machine-learning)
...
\]  [geeksforgeeks](https://www.geeksforgeeks.org/data-science/how-to-calculate-entropy-in-decision-tree/)
...
If another candidate split produced children with higher weighted entropy (e.g., 0.85), its information gain (0.971 − 0.85 ≈ 0.121) would be smaller, so the tree would prefer the first split. [community.deeplearning](https://community.deeplearning.ai/t/confusion-about-the-concepts-of-entropy-and-information-gain-in-decision-tree/686640)
